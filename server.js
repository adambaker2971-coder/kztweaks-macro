...
// ============================================================================
// FILE SERVER - Serve ALL app files from Railway
// ============================================================================

const createFileServerRouter = require('./file-server');
const fileServerRouter = createFileServerRouter();
app.use('/', fileServerRouter);
